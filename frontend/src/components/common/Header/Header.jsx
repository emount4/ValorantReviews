        ...
        <div className={styles.headerConten}>
          ...
          <div className={styles.authButtons}>
            {isAuthenticated ? (
              <div className={styles.userMenu}>
                ...
                <div className={styles.profileDropdown}>
                  ...
                  <div className={styles.dropdownMenu}>
                    <NavLink to="/account" className={styles.dropdownItem} onClick={closeMobileMenu}>
                      📱 Профиль
                    </NavLink>
                    <button 
              ...
              <>
                <button className={styles.loginBtn} onClick={openAuthModal}>Войти</button>
                <button className={styles.registerBtn} onClick={openRegistrationModal}>Регистрация</button>
              </>
            )}
          </div>
