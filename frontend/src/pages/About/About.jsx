      ...
      <div className={styles.aboutContainer}>
        <section className={styles.introSection}>
          <h1 className={styles.mainTitle}>
            Оценка скинов Valorant - Valorant Reviews
          </h1>

          <div className={styles.aboutContent}>
            <p className={styles.aboutText}>
              Это первый подобный проект в моей жизни и реализовывается он в
              первую очередь в целях получения опыта подобного рода разработки.
            </p>

            <p className={styles.aboutText}>
              В общий, максимально широкий концепт веб-сайта входит задача
              реализовать систему по оцениванию коллекций скинов из игры
              компании Riot Games Valorant (в ходе разработки спектр задач может
              как расшириться, так и сузиться - все-таки это мой первый проект и
              разрабатываю я его один).
            </p>

            <p className={styles.aboutText}>
              Соответственно, на этом сайте можно будет создать аккаунт и
              ставить оценки/писать рецензии на скины. Исходя из рецензий, будут
        ...
        {/* Как это работает - УСЛОЖНЕННАЯ СЕТКА */}
        <section className={styles.previewSection}>
          <h2 className={styles.sectionTitle}>Как это работает?</h2>
          <div className={styles.previewGrid}>
            <div className={`${styles.previewItem} ${styles.previewItemMain}`}>
              <div className={styles.previewIcon}>1</div>
              <h3 className={styles.previewTitle}>Регистрируйтесь</h3>
              <p className={styles.previewText}>
                Создайте аккаунт и настройте профиль
              </p>
            </div>
            <div className={styles.previewItem}>
              ...
              <p className={styles.previewText}>
                Используйте 90-балльную систему оценок
              </p>
            </div>
            <div className={`${styles.previewItem} ${styles.previewItemWide}`}>
              <div className={styles.previewIcon}>3</div>
              <h3 className={styles.previewTitle}>Пишите рецензии</h3>
              <p className={styles.previewText}>
                Делитесь подробным мнением о скинах и участвуйте в обсуждениях
              </p>
            </div>
            <div className={styles.previewItem}>
              <div className={styles.previewIcon}>4</div>
              <h3 className={styles.previewTitle}>Следите за рейтингом</h3>
              <p className={styles.previewText}>
                Отслеживайте позиции в общем рейтинге
              </p>
            </div>
            <div className={styles.previewItem}>
              <div className={styles.previewIcon}>5</div>
              <h3 className={styles.previewTitle}>Создавайте коллекции</h3>
              <p className={styles.previewText}>
                Формируйте персональные подборки скинов
              </p>
            </div>
            <div className={`${styles.previewItem} ${styles.previewItemMain}`}>
              <div className={styles.previewIcon}>6</div>
              <h3 className={styles.previewTitle}>Соревнуйтесь</h3>
              <p className={styles.previewText}>
                Поднимайтесь в топах рейтинга и получайте достижения
              </p>
            </div>
          </div>
        </section>
        ...
        <section className={styles.roadmapSection}>
          ...
          <div className={styles.roadmapList}>
            ...
            <div className={styles.roadmapItem}>
              <span className={styles.roadmapStatus}>🔄</span>
              <span className={styles.roadmapText}>
            ...
            <div className={styles.roadmapItem}>
              <span className={styles.roadmapStatus}>⏳</span>
              <span className={styles.roadmapText}>
                Интеграция с трекерами статистики
              </span>
            </div>
          </div>
        </section>
        ...
        <section className={styles.ctaSection}>
          ...
          <p className={styles.ctaText}>
            Начните оценивать скины и делиться своим мнением
          </p>
        ...
        <section className={styles.telegramSection}>
          <div className={styles.contactInfo}>
            ...
            <p className={styles.contactText}>
              Есть вопросы или предложения? Пишите в Telegram!
            </p>
          </div>
          <a
