...
import telegramIcon from "../../../public/Telegram SVG Icon.svg"; // Путь к локальной иконке (поместите файл сюда)
    ...
    <div className={styles.aboutContainer}>
      ...
      <section className={styles.introSection}>
        <p className={styles.aboutText}>
          ...
          очередь в целях получения опыта подобного рода разработки. В общий,
          максимально широкий концепт веб-сайта входит задача реализовать
          ...
          формироваться рейтинги коллекций и топы лучших. Система во многом
          вдохновлена проектом РЗТ, и унаследует от него 90-бальную систему (в
          дань уважения и в качестве отсылки), переосмысленную в рамках
          концепта.
        </p>
      </section>
